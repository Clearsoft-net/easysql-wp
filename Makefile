...
cli:
	PODMAN_SHORTNAME_ALIASING=0 npx @wordpress/env run cli wp $(ARGS)
...
start:
	PODMAN_SHORTNAME_ALIASING=0 npx @wordpress/env start

stop:
	PODMAN_SHORTNAME_ALIASING=0 npx @wordpress/env stop
